    ...
    <section className="py-16 sm:py-24 bg-white">
      <Container>
        <SectionHeading
          ...
          subtitle="From emergency repairs to new installations, we keep Austin homes comfortable year-round."
        />
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <Link
              ...
              className="group rounded-xl border border-gray-200 bg-white p-6 transition-all hover:border-brand-200 hover:shadow-lg"
            >
              <div className="mb-4 inline-flex rounded-lg bg-brand-50 p-3 text-brand-600 transition-colors group-hover:bg-brand-600 group-hover:text-white">
